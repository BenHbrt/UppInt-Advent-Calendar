...
const Naughty = ({ setDisplay }) => {
    return (
        <div className="credits">
            ...
            <p>The inspiration for this project came as a result of brainstorming app ideas with a friend, Renee Selikowitz, as well as my background in English langauge teaching.</p>
