    ...
    return (
        <div className="credits">
            ...
            <p>The images used in this project were taken from <a href="https://pixabay.com/">pixabay.com</a>, and direct links to them can be found below.</p>
                <a href="https://pixabay.com/photos/christmas-background-flat-lay-1911637/"><img src={require("../Images/hd-wallpaper-g96f4c3791_1280.jpg")} alt="A christmas image" /></a>
                <a href="https://pixabay.com/vectors/holly-ilex-leaves-thorny-spiky-152061/"><img src={require("../Images/holly-g5eb13151e_640.png")} alt="A christmas image" /></a>
